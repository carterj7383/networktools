...
@app.route('/')
def home():
    # Example results dictionary (replace with actual logic if needed)
    results = {
        "binary_to_decimal": [
            {"question": "1010", "user_answer": "10", "correct_answer": "10", "result": "Correct"}
        ],
        "decimal_to_binary": [
            {"question": "10", "user_answer": "1010", "correct_answer": "1010", "result": "Correct"}
        ]
    }
